...
- [ ] Module 2 : Restaurants & succursales — *étapes 1-8 (conception + backend FastAPI + tests, 47/47 passés sous PostgreSQL réel) livrées le 2026-08-07, voir [docs/modules/02-restaurants-succursales/](./docs/modules/02-restaurants-succursales/) et [backend/](./backend/) — reste : Flutter (mobile/web), documentation finale, validation*
