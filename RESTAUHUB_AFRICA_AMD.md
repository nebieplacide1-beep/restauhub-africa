...
- [ ] Module 1 : Authentification & gestion des tenants — *étapes 1-8 (conception + backend FastAPI + tests, 21/21 passés sous PostgreSQL réel) livrées le 2026-08-07, voir [docs/modules/01-auth-tenants/](./docs/modules/01-auth-tenants/) et [backend/](./backend/) — reste : mot de passe oublié, Flutter (mobile/web), documentation finale, validation*
