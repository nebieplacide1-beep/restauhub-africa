...
- [ ] Module 1 : Authentification & gestion des tenants — *étapes 1-7 (conception + backend FastAPI) livrées le 2026-08-07, voir [docs/modules/01-auth-tenants/](./docs/modules/01-auth-tenants/) et [backend/](./backend/) — reste : exécuter les tests d'intégration/API sous PostgreSQL, mot de passe oublié, Flutter, documentation finale, validation*
